...
public interface SubmissionCommentRepository extends JpaRepository<SubmissionComment, Long> {
    ...
    /**
     * Find all comments for a submission ordered by creation date
     */
    ...
    /**
     * Find comments by scope (PRIVATE for teacher feedback, PUBLIC for class discussion)
     */
    ...
    /**
     * Check if comment belongs to submission
     */
